# Issue Tracker: Technical Reference and Generated-Code Appendix

> **This is an optional deep-dive document for developers and auditors.**
> It contains line-by-line source annotation, full generated-code excerpts,
> pipeline internals, security architecture notes, and a reproduction
> checklist. You do not need to read this to use IntentLang.
>
> For the 5-minute layperson-friendly story, see
> [`issue-tracker-full-stack.md`](issue-tracker-full-stack.md).
